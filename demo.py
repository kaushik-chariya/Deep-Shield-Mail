...
if __name__ == "__main__":
    try:
        ...
        csv_path = "data/raw/archive/spam_assassin.csv"

        # ─────────────────────────────────────────────
        # Step 1 → Insert CSV into PostgreSQL
        # ─────────────────────────────────────────────
        logger.info("📂 Starting CSV insertion process")
        email_obj = EmailData()
        email_obj.insert_csv_to_postgres(csv_path)
        logger.info("✅ CSV insertion completed")
        ...
        logger.exception("❌ Error occurred in demo.py")
